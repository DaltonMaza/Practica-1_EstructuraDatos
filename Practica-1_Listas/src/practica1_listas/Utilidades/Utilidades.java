 ...
 */
package practica1_listas.Utilidades;
...
import practica1_listas.modelo.Rango;
...
public class Utilidades {
    ...
    public static void guardarJSON(EmpresaController ec) throws FileNotFoundException{
        ...
        try {
            PrintWriter escritor = new PrintWriter(new File("empresa-Listas.json"));
            escritor.write(json);
            escritor.flush();
            escritor.close();
    ...
    public static EmpresaController leerJson() throws IOException{
        ...
        Reader lector = Files.newBufferedReader(Paths.get("empresa-Listas.json"));
        Gson gson = new Gson();
