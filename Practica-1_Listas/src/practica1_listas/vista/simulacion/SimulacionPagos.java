 ...
 */
package practica1_listas.vista.simulacion;
...
public class SimulacionPagos extends javax.swing.JDialog implements Runnable {
    ...
    public SimulacionPagos(java.awt.Frame parent, boolean modal) {
        ...
        mt.setTrabajadores(empresaC.getEmpresa().getTrabajadorList());
    ...
    public void run() {
        ...
        ModeloTablaTrabajadores mtpaux = new ModeloTablaTrabajadores();
        Integer count = mt.getTrabajadores().getTamanio();
        Trabajador t1 = new Trabajador();
        cargarTabla1(mt, tblPorPagar);
        cargarTabla1(mtpaux, tblPagados);
        for (int i = 0; i < count; i++) {
            try {
                Thread.sleep(3000);
                t1 = mt.getTrabajadores().eliminarPosicion(0);
                t1.setPagado(true);
                aux.insertar(t1);
                mtpaux.setTrabajadores(aux);
                cargarTabla1(mt, tblPorPagar);
                cargarTabla1(mtpaux, tblPagados);
